...
void ALEInterface::setStartandGoalPosition(int start_x, int start_y, int goal_x, int goal_y){
  romSettings->setStartandGoalPosition(start_x, start_y, goal_x, goal_y);
}
